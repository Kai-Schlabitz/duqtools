...
@click.option("--force", is_flag=True, help="Overwrite existing run config directories")
...
@click.option(
    ...
    "--pattern",
    type=str,
    help="Only create data for configs in subdirectories matching this glob pattern.",
)
@click.option(
    "-i",
    "--input",
    "input_file",
    type=str,
    help="Only create data for configs where `template_data` matches a handle in this data.csv.",
)
@click.option(
    "--no-sampling",
    is_flag=True,
...
@click.option(
    ...
    "--pattern",
    type=str,
    help="Only submit jobs for runs in subdirectories matching this glob pattern.",
)
@click.option(
    "-i",
    "--input",
    "input_file",
    type=str,
    help="Only submit jobs for configs where `template_data` matches a handle in this data.csv.",
)
...
@click.option(
    ...
    "--pattern",
    type=str,
    help="Show status only for runs in subdirectories matching this glob pattern.",
)
