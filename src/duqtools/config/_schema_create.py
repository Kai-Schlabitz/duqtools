...
from ..schema.data_location import DataLocation
...
class CreateConfigModel(BaseModel):
    ...
    template_data: Optional[ImasBaseModel] = Field(
        None,
        description=f(
            """
    ...
    sampler: Union[LHSSampler, HaltonSampler, SobolSampler, CartesianProduct] = Field(
        CartesianProduct(),
    ...
    data: Optional[DataLocation] = Field(
        None,
        description=f(
            """
