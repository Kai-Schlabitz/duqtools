...
class ConfigModel(BaseModel):
    ...
    tag: str = Field(
        "",
        description="Create a tag for the runs to identify them in slurm or `data.csv`",
    )

    create: Optional[CreateConfigModel] = Field(
        None,
        description="Configuration for the create subcommand. See model for more info.",
    )
    ...
    quiet: bool = Field(
        False,
        description="If true, do not output to stdout, except for mandatory prompts.",
    )
