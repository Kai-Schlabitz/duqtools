...
def test_clean(duqtools_tmpdir):
    ...
    assert ret.output.strip() == "[Errno 2] No such file or directory: 'duqtools.yaml'"
...
def test_merge(duqtools_tmpdir):
    ...
    assert ret.output.splitlines()[-1] == "Error: Missing option '-t' / '--template'."
